...
source(here("functions", "add_US_location.R"))
```
...
- 37% of the Tweets were created by the users located in the US.
...
twitter_plot <- bind_rows(mutate(add_normalized(df, asian), Terms = "Asian"), 
