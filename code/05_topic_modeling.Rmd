...
keywords <- list("Anti-Asian" = c("wuhanvirus", "chinesevirus", "chinavirus", "wuhancoronavirus", "wuhanpneumonia", "ccpvirus", "chinaliedpeopledied"),
                 "Anti-racism" = c("antiracism", "stophate", "acttochange", "stopaapihate", "stophatecrimes", 
                                   # Only these three worked 
                                   "antiasian", "racism", "racist"))
...
ggsave(here("outputs", "k_search_diag.png"), width = 4, height = 4)
